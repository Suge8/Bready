...
import { type InterviewUsageRecord } from '../../lib/api-client'
    ...
    <div ref={containerRef} className="space-y-3">
      ...
      {groupedRecords.map((group, groupIndex) => (
        ...
        >
          ...
          <div
            className={cn(
              'flex items-center gap-1.5 mb-1.5 px-0.5 text-[10px] font-semibold tracking-wider uppercase opacity-80',
              isDarkMode ? 'text-gray-500' : 'text-gray-400',
            )}
          >
      ...
      {hasMore && (
        <motion.button
          ...
          disabled={loading}
          className={cn(
            'w-full py-2 rounded-lg border text-xs font-medium flex items-center justify-center gap-1.5',
