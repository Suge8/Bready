...
export const translations: Record<SupportedLanguage, any> = {
  'cmn-CN': {
    ...
    login: {
      ...
      hero: {
        title: '掌控你的\n下一次面试',
        subtitle: '你的智能面试副驾驶，提供实时辅助、语音分析和信心建设。',
        features: {
          analysis: '实时 AI 分析',
          transcription: '语音转写',
          suggestions: '智能回答建议',
  ...
  'en-US': {
    ...
    login: {
      ...
      hero: {
        title: 'Master Your\nNext Interview',
        subtitle:
          'Your intelligent copilot for real-time interview assistance, speech analysis, and confidence building.',
        features: {
          analysis: 'Real-time AI Analysis',
          transcription: 'Speech Transcription',
          suggestions: 'Smart Answer Suggestions',
        },
  ...
  'ja-JP': {
    ...
    login: {
      ...
      hero: {
        title: '次回の面接を\nマスターする',
        subtitle: 'リアルタイムの面接支援、音声分析、自信構築のためのインテリジェントな副操縦士。',
        features: {
          analysis: 'リアルタイムAI分析',
          transcription: '音声文字起こし',
          suggestions: 'スマートな回答提案',
        },
        footer: '© 2026 Bready Inc. All rights reserved.',
      },
    },
  ...
  'fr-FR': {
    ...
    login: {
      ...
      hero: {
        ...
        subtitle:
          "Votre copilote intelligent pour l'assistance en temps réel, l'analyse vocale et la confiance.",
        features: {
          analysis: 'Analyse IA temps réel',
